...
# Calculate critical value for a desired confidence level
confidence_level <- 0.95
alpha <- 1 - confidence_level
critical_value <- qt(1 - alpha / 2, df = num_samples - 1)

# Calculate confidence interval
lower_bound <- mean_of_means - critical_value * standard_error
upper_bound <- mean_of_means + critical_value * standard_error
